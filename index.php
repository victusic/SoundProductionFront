<?php 
	...
	//setcookie('inf_cookie', $_POST['name'], time() - 604800, '/');
	//setcookie('themes', $_POST['name'], time() - 604800, '/');

	/*$rpr = 'Victusic';
	// Открываем на чтение поток ввода
	$f = fopen('http://localhost:60781/api/getUsers?login='.$rpr, 'r');
...
<html>
	<head>
		...
		<link href="files/css/pages/index_page.css" rel="stylesheet">
		<link href="files/css/system/colors.css" rel="stylesheet">
		<link href="files/css/system/reset.css" rel="stylesheet">
		<link href="files/css/system/base.css" rel="stylesheet">
		<link href="files/css/system/fonts.css" rel="stylesheet">

		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
		<script src='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js'></script>
		<script src="https://cdn.jsdelivr.net/npm/jquery.maskedinput@1.4.1/src/jquery.maskedinput.min.js"></script>
		<script src="files/scripts/pages/index_page.js"></script>
		<script src="files/scripts/system/base.js"></script>

		<link type="image/x-icon" rel="shortcut icon" href="files/img/icon/favicon.ico">
	</head>
	<body>
		<div class="base" id="base">
			...
			<nav id="nav">
				...
				<input type="button" id="news" class="navbtn btn" value="Новости">
					<div id="news_list" class="news_list doplist">
						...
						<div class="listbtn" onclick="window.location.href ='files/pages/news_industry.php';">Новости индустрии</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/news_company.php';">Новости компании</div>
						<div class="nav_line"></div>
					</div>
				<input type="button" id="about" class="navbtn btn" value="О нас">	
					<div id="about_list" class="about_list doplist">
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/about_achievements.php';">Наши достижения</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/about_ethics.php';">Корпоративная этика</div>
						<div class="nav_line"></div>
					</div>
				<input type="button" id="coop" class="navbtn btn" value="Сотрудничество">
					<div id="cooperation_list" class="cooperation_list doplist">
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/cooperation_jobs.php';">Вакансии</div>
						<div class="nav_line"></div>
						<div class="listbtn">Пользование сервисом</div>
						<div class="nav_line"></div>
					</div>
				...
				<input type="button" id="prod" class="navbtn btn" value="Личный кабинет">
					<div id="ls3" class="lk_list doplist">
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/records_group.php';">Ваши записи</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/advertisements_group.php';">Ваши объявления</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/visible_area.php';">Просмотр площадок</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/profile.php';">Управление аккаунтом</div>
						<div class="nav_line"></div>
						<form action="files/php/exit.php">
				...
				<input type="button" id="manag" class="navbtn btn" value="Личный кабинет">
					<div id="ls4" class="lk_list doplist">
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/records_area.php';">Ваши записи</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/advertisements_area.php';">Ваши объявления</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/visible_group.php';">Просмотр групп</div>
						<div class="nav_line"></div>
						<div class="listbtn" onclick="window.location.href ='files/pages/profile.php';">Управление аккаунтом</div>
						<div class="nav_line"></div>
						<form action="files/php/exit.php">
			...
			<div class="back" id="back">
				<div class="list1 lists">
					<div class="container">
						<div class="owl-demo">
							<div id="myCarousel" class="owl-carousel owl-theme">
								<div id="slider1" class="item owl-lazy" data-src="files/img/slider/1.jpg">
									<div class="sliderContent">
										<div class="sliderContentInner">
											<div class="zglslider">&nbspСделайте мир лучше</div>
											<div class="sliderTxt">&nbsp | Организуйте различные мероприятия на нашей платформе и развивайте свои способности</div>
											<input type="button" id="sliderbut1" class="sliderBtn btn" value="Перейти">
										</div>
									</div>
								</div>
								<div class="item owl-lazy" data-src="files/img/slider/2.jpg">
									<div class="sliderContent">
										<div class="sliderContentInner">
											<div class="zglslider">&nbspОцените наши предложения</div>
											<div class="sliderTxt">&nbsp | Попробуйте предложения нашего сайта и насладитесь удобными услугами</div>
											<input type="button" id="sliderbut2" class="sliderBtn btn" value="Перейти">
										</div>
									</div>
								</div>
								<div class="item owl-lazy" data-src="files/img/slider/3.jpg">
									<div class="sliderContent"><!-- - для осветления нижний части-->
										<div class="sliderContentInner">
											<div class="zglslider">&nbspРаботаем для вас</div>
											<div class="sliderTxt">&nbsp | Мы рады, что вы развиваетесь вместе с нами</div>
											<input type="button" id="sliderbut3" class="sliderBtn btn" value="Перейи">
										</div>
									</div>
								</div>
							</div>
			...
			<footer>
				...
				<div class="colmn"><div class="incolmn"><div class="ftext footer_text" onclick="window.location.href ='files/pages/news_head.php';"><b>Новости</b></div>
					<div class="fline"></div>
					<div class="stext footer_text" onclick="window.location.href ='files/pages/news_industry.php';">Новости индустрии</div>
					<div class="stext footer_text" onclick="window.location.href ='files/pages/news_company.php';">Новости компании</div>
				</div></div>
					<div class="colmn"><div class="incolmn"><div class="ftext footer_text" onclick="window.location.href ='files/pages/about_head.php';"><b>О нас</b></div>
					<div class="fline"></div>
					<div class="stext footer_text" onclick="window.location.href ='files/pages/about_achievements.php';">Наши достижения</div>
					<div class="stext footer_text" onclick="window.location.href ='files/pages/about_ethics.php';">Корпоративная этика</div>
				</div></div>
					<div class="colmn"><div class="incolmn"><div class="ftext footer_text" onclick="window.location.href ='files/pages/cooperation_head.php';"><b>Сотрудничество</b></div>
					<div class="fline"></div>
					<div class="stext footer_text" onclick="window.location.href ='files/pages/cooperation_jobs.php';">Вакансии</div>
					...
					<div class="stext footer_text" id="pr-z" onclick="window.location.href ='files/pages/records_group.php';">Ваши записи</div>
					<div class="stext footer_text" id="pr-o" onclick="window.location.href ='files/pages/advertisements_group.php';">Ваши объявления</div>
					<div class="stext footer_text" id="pr-p" onclick="window.location.href ='files/pages/visible_area.php';">Просмотр площадок</div>
					<div class="stext footer_text" id="man-z" onclick="window.location.href ='files/pages/records_area.php';">Ваши записи</div>
					<div class="stext footer_text" id="man-o" onclick="window.location.href ='files/pages/advertisements_area.php';">Ваши объявления</div>
					<div class="stext footer_text" id="man-g" onclick="window.location.href ='files/pages/visible_group.php';">Просмотр групп</div>
				</div></div>
			</footer>
			<div class="socialline">
				...
				<div class="link"><div class="linkimg" id="linkMail" onclick="window.location.href ='files/pages/contact_form.php';"></div></div>
			</div>
			...
			<div class="autorisation-block" id="autorise-block">
				<div class="inblok-relative" id="lg_bl">
					...
					<form id="formV" action="files/php/login.php" method="POST">
...
<?php
	if ($_SESSION['roll'] == '3') {
		echo "<script src='files/scripts/system/show_producer.js'></script>";
	}
	else if ($_SESSION['roll'] == '4') {
		echo "<script src='files/scripts/system/show_manager.js'></script>";
	}
	else if ($_SESSION['roll'] == '000') {
		echo "<script src='files/scripts/system/error_login.js'></script>";
		session_destroy();
	}
	...
	if (isset($_COOKIE["inf_cookie"]) != null){
		if ($_COOKIE["inf_cookie"] == "1") {
			echo "<script src='files/scripts/system/cookie_info.js'></script>";
		}
	}
	else{
		echo "<script src='files/scripts/system/cookie_info.js'></script>";
	...
	if (isset($_COOKIE["themes"]) != null){
		if ($_COOKIE["themes"] == "black") {
			echo "<script src='files/scripts/system/themdark.js'></script>";
		}
		if ($_COOKIE["themes"] == "white") {
			echo "<script src='files/scripts/system/themwhite.js'></script>";
		}
	}
	else{
		echo "<script src='files/scripts/system/cookie_info.js'></script>";
