...
<html>
	<head>
		...
		<link href="../css/pages/advertisements_group_page.css" rel="stylesheet">
		...
		<script src="../scripts/pages/advertisiment_group.js"></script>
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="list0 lists">
					<div class="head_text"><b>Ваши объявления</b></div>
				</div>
				<div class="listr lists" id="listr">
					...
					<div class="listview_plate" id="livi_plateS">
						<!--<div class="listview" id="listview">
							<div class="lv_img" id="lv_img"></div>
							<div class="lv_name" id="lv_name">Название</div>
							<div class="lv_group" id="lv_group">Описание группы</div>
							<div class="lv_area" id="lv_area">Описание площадки</div>
							<div class="lv_state" id="lv_state">Статус</div>
							<div class="lv_phone" id="lv_phone">Телефон</div>
							<div class="lv_mail" id="lv_mail">Адрес почты</div>
							<div class="lv_genre" id="lv_genre">Жанр</div>
							<div class="lv_photos" id="lv_photos">Фотографии</div>
							<div class="lv_links" id="lv_links"></div>
							<div class="lv_time" id="lv_time"></div>
							<div class="lv_visible" id="lv_visible"></div>
						</div>-->
					</div>
				</div>
				...
				<div class="listn lists" id="list3">
					<div class="list2_panl_name">Статистика</div>
					<div class="font_z" id="fnt1">Устройства</div>
					<div id="chart_round"></div>
					<div class="font_z" id="fnt2">Количество посещений</div>
					<div id="chart_column"></div>
					<div class="font_z" id="fnt3">Среднее время посещения</div>
