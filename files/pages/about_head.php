...
<html>
	<head>
		...
		<link href="../css/pages/about_head.css" rel="stylesheet">
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				...
				<div class="list2 lists">
					<input type="button" class="btn n-btn" id="lb1" value="Перейти" onclick="window.location.href ='about_achievements.php';"></input>
					<div class="zg_text">Достижения нашей компании</div>
					<div class="cl_text">
				...
				<div class="list3 lists">
					<input type="button" class="btn n-btn" id="lb2" value="Перейти" onclick="window.location.href ='about_ethics.php';"></input>
					<div class="zg_text">Корпоративная этика</div>
					<div class="cl_text">
						Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек;
					</div>
