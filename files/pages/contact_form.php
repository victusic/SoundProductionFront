...
<html>
	<head>
		...
		<link href="../css/pages/contact_page.css" rel="stylesheet">
		...
		<script src="../scripts/pages/contact_page.js"></script>
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="message-box" id="mbox-code">
					<div class="message-box-title">Уведомление</div> 
					<div class="message-box-text" id="mbox-txt">Сообщение отправленно</div>
					<input type="button" class="message-box-button" id="mbox-btn" value="Отлично" style="margin-top: 35px;">
					<div class="message-box-exit" id="mbox-exit">&#10006</div>
				</div>
				<div class="list0 lists">
					<div class="head_text"><b>Контактная форма</b></div>
				</div>
				<div class="listr lists">
					<div class="Vr-preview-text" id="tx1">Имя</div>
					<input type="text" class="vr_input2" id="in1">
					<div class="Vr-preview-text" id="tx2">Почта</div>
					<div class="paste_mail" id="paste_mail_pm">⎀</div>
					<input type="text" class="vr_input2" id="in2">
					<div class="Vr-preview-text" id="tx3">Тема</div>
					<input type="text" class="vr_input2" id="in3">
					<div class="Vr-preview-text" id="tx4">Текст</div>
					<textarea class="vr_input2" id="in4"></textarea>
					<input type="button" name="sub" class="subbtn" id="sub" value="Отправить письмо">
					<div class="quad_creative">
						<div id="quad1" class="quads"></div>
						<div id="quad2" class="quads"></div>
						<div id="quad3" class="quads"></div>
						<div id="quad4" class="quads"></div>
						<div id="quad5" class="quads"></div>
						<div id="quad6" class="quads"></div>
						<div id="quad7" class="quads"></div>
						<div id="quad8" class="quads"></div>
						<div id="quad9" class="quads"></div>
						<div id="quad10" class="quads"></div>
						<div id="quad11" class="quads"></div>
						<div id="quad12" class="quads"></div>
						<div id="quad13" class="quads"></div>
						<div id="quad14" class="quads"></div>
						<div id="quad15" class="quads"></div>
					</div>
				</div>
			</div>
			<footer>
...
<?php
	...
	if(!isset($_SESSION['roll'])){
		echo "<script>$('#paste_mail_pm').css('display', 'none');</script>";
	}
