...
<html>
	<head>
		...
		<link href="../css/pages/news_head.css" rel="stylesheet">
		<link href="../css/pages/heads_page.css" rel="stylesheet">
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="list1 lists">
					<div class="head_text"><b>Новости</b></div>

				</div>
				<div class="list2 lists">
					<input type="button" class="btn n-btn" id="lb1" value="Перейти" onclick="window.location.href ='news_industry.php';"></input>
					<div class="zg_text">Новости индустрии</div>
					<div class="cl_text">
						Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек;
					</div>
					<div class="sl_img" id="sli1"></div>
				</div>
				<div class="list3 lists">
					<input type="button" class="btn n-btn" id="lb2" value="Перейти" onclick="window.location.href ='news_company.php';"></input>
					<div class="zg_text" >Новости компании</div>
					<div class="cl_text">
						Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек;
					</div>
					<div class="sl_img" id="sli2"></div>
				</div>
			</div>
			<footer>
			...
			<div class="socialline">
				...
				<div class="link"><div class="linkimg" id="linkMail" onclick="window.location.href ='../pages/contact_form.php';"></div></div>
			</div>
