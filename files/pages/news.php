...
<html>
	<head>
		...
		<script src="../scripts/pages/news_page.js"></script>
	...
	<body>
		<div class="base2" id="base">
			...
			<div class="back2" id="back">
				<div class="list0 lists">
					<div class="head_text" id="news_zagl"><b>Новость</b></div>
				</div>
				<div class="listr2 lists">
					<div class="cl_text" id="hews_text">
						Текст
					</div>
					<div class="dt_text" id="dt_text">date</div>
				</div>
			</div>
			<footer>
			...
			<div class="socialline">
				...
				<div class="link"><div class="linkimg" id="linkVk" 
					onclick="window.open('https://vk.com/public208880883')"></div></div>
				...
				<div class="link"><div class="linkimg" id="linkInstagram" 
					onclick="window.open('https://www.instagram.com/soundproductionru')"></div></div>
