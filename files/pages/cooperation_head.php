...
<html>
	<head>
		...
		<link href="../css/pages/cooperation_head.css" rel="stylesheet">
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="list1 lists">
					<div class="head_text"><b>Сотрудничество с нами</b></div>
				</div>
				<div class="list2 lists">
					<input type="button" class="btn n-btn" id="lb1" value="Перейти" onclick="window.location.href ='cooperation_jobs.php';"></input>
					<div class="zg_text">Вакансии</div>
					<div class="cl_text">
				...
				<div class="list3 lists">
					<input type="button" class="btn n-btn" id="lb2" value="Перейти" onclick="window.location.href ='cooperation_policy.php';"></input>
					<div class="zg_text">Правила пользования сервисом</div>
					<div class="cl_text">
						Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек; Умный и красивый текст в несколько строчек;
					</div>
