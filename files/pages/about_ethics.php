		...
		<div class="base" id="base">
			...
			<div class="back4" id="back4">
				<div class="list0 lists">
					<div class="head_text"><b>О нас</b></div>
				</div>
				<div class="listr lists">
					<div class="imga imga-static" id="img_collective"><div class="imgb"></div></div>
					<div class="zg_text zg_text-static">&nbsp&nbspМы дружный коллектив </div>
					<div class="Rstxt Rstxt-static">Мы - молодая быстро развивающаяся компания в сфере It. Наш сервис уже запущен на многих платформах, а сейчас мы активно осваиваем новые</div>
				</div>
				<div class="listr lists">
					<div class="imga imga-reverse" id="img_office"><div class="imgb"></div></div>
					<div class="zg_text zg_text-reverse">Хз&nbsp&nbsp</div>
					<div class="Rstxt Rstxt-reverse">Команда наших специалистов находится в непрерывном процессе улучшения продукта: мы постоянно совершенствуем сервис, чтобы добиться необходимого результата</div>
				</div>
				<div class="listr lists">
					<div class="imga imga-static" id="img_study2"><div class="imgb"></div></div>
					<div class="zg_text zg_text-static">&nbsp&nbspМы работаем со студентами</div>
					<div class="Rstxt Rstxt-static">Прежде всего наша компания ценит своих сотрудником. Именно поэтому мы предоставляем все необходимые возможности для постоянного усовершенствования их знаний и профессиональных навыков, а благодаря системе стажировок студенты могут получить новый опыт</div>
				</div>
				<div class="listr lists">
					<div class="imga imga-reverse" id="img_product"><div class="imgb"></div></div>
					<div class="zg_text zg_text-reverse">Kоллектив&nbsp&nbsp</div>
					<div class="Rstxt Rstxt-reverse">Дружный коллектив - залог успешной работы всей компании</div>
				</div>
			</div>
			<footer>
