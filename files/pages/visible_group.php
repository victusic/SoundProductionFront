...
<html>
	<head>
		...
		<link href="../css/pages/visible_group_page.css" rel="stylesheet">
		...
		<script src="../scripts/pages/visible_group.js"></script>
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="list0 lists">
					<div class="head_text"><b>Группы</b></div>
				</div>
				...
				<div class="listb lists" id="list2">
					...
					<div class="pre_list2_dimg">
						<div class="list2_dimg" id="l2_list"></div>
					</div>
				</div>
			</div>
			<footer>
