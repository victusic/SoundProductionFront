...
<html>
	<head>
		...
		<link href="../css/pages/records_group_page.css" rel="stylesheet">
		...
		<script src="../scripts/pages/records_group_page.js"></script>
		...
		<div class="base" id="base">
			...
			<div class="back" id="back">
				<div class="list0 lists">
					<div class="head_text"><b>Ваши записи (группы)</b></div>
				</div>
				...
				<div class="listr lists" id="list2">
					...
					<div class="list2_txt" id="l2_inp_name">Название группы</div>
					<textarea class="list2_inp_name" id="list2_inp_name"></textarea>
					<div class="list2_txt" id="l2_genre">Музыкальное направление</div>
					<select name="Genres" class="list2_genre" id="list2_genre">
						<option selected="selected">Выберите жанр</option>
						<option value="1">Rock</option>
						<option value="2">Metall</option>
						...
						<option value="11">Autors Song</option>
						<option value="12">Indie</option>
						<option value="13">Another</option>
				   </select>
					<div class="list2_txt" id="l2_group">Описание группы</div>
					...
					<div class="list2_txt" id="l2_spotify">Ссылка Spotify</div>
					<textarea class="list2_spotify" id="list2_spotify"></textarea>
					<div class="list2_txt" id="l2_apple">Ссылка Apple Music</div>
					<textarea class="list2_apple" id="list2_apple"></textarea>
					<div class="list2_txt" id="l2_deezer">Ссылка Deezer</div>
					<textarea class="list2_deezer" id="list2_deezer"></textarea>
					<div class="list2_txt" id="l2_yandex">Ссылка Yandex</div>
					<textarea class="list2_yandex" id="list2_yandex"></textarea>
					<div class="list2_txt" id="l2_youtube">Ссылка YouTube</div>
					<textarea class="list2_youtube" id="list2_youtube"></textarea>
					<div class="list2_txt" id="l2_youtubemusic">Ссылка YouTube Music</div>
					<textarea class="list2_youtubemusic" id="list2_youtubemusic"></textarea>
					<div class="list2_txt" id="l2_dimg">Изображения группы</div>
				...
				<div class="listr lists" id="list3">
					...
					<div class="list2_name" id="list3_name">&nbsp&nbspНовая группа</div>
					<div class="list2_txt" id="l3_inp_name">Название группы</div>
					<textarea class="list2_inp_name" id="list3_inp_name"></textarea>
					<div class="list2_txt" id="l3_genre">Музыкальное направление</div>
					<select name="Genres" class="list2_genre" id="list3_genre">
						<option selected="selected">Выберите жанр</option>
						<option value="1">Rock</option>
						<option value="2">Metall</option>
						<option value="3">Rap</option>
					...
					<div class="list2_txt" id="l3_group">Описание группы</div>
					...
					<div class="paste_mail past_txt" id="paste_mail3">⎀</div>
					<div class="list2_txt" id="l3_phone">Номер телефона для связи</div>
					<textarea class="list2_phone" id="list3_phone"></textarea>
					<div class="paste_phone past_txt" id="paste_phone3">⎀</div>
					<div class="list2_txt" id="l3_spotify">Ссылка Spotify</div>
					<textarea class="list2_spotify" id="list3_spotify"></textarea>
					<div class="list2_txt" id="l3_apple">Ссылка Apple Music</div>
					<textarea class="list2_apple" id="list3_apple"></textarea>
					<div class="list2_txt" id="l3_deezer">Ссылка Deezer</div>
					<textarea class="list2_deezer" id="list3_deezer"></textarea>
					<div class="list2_txt" id="l3_yandex">Ссылка Yandex</div>
					<textarea class="list2_yandex" id="list3_yandex"></textarea>
					<div class="list2_txt" id="l3_youtube">Ссылка YouTube</div>
					<textarea class="list2_youtube" id="list3_youtube"></textarea>
					<div class="list2_txt" id="l3_youtubemusic">Ссылка YouTube Music</div>
					<textarea class="list2_youtubemusic" id="list3_youtubemusic"></textarea>
					<div class="list2_txt" id="l3_dimg">Изображения группы</div>
					<div class="list2_dimg">
						<div class="flex_dimg">
